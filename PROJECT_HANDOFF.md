...
- **75건 | 승률 37.3% | 평균실현 +0.65% | 누적 +59.1% | MDD -12.2%**
- 시그널: R1 71 / R3 213 / R4 13 / R5 734 / R7 26 / R8 19 / R9 6 / R10 46 / R11 9
- 패턴: R10 선발대 손절(-0.80%=20%×-4%)이 다수, 승자는 R8→R7 체인 +2~4%.
  선발대 20% 구조 덕에 MDD 가 v2(-21.7%)보다 낮음. 데이터 갭 0종목.
- 시그널 1,137행 gm_v3_signals 적재(run_id=gm3_oos_45_6, 멱등).
