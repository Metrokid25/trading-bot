...
> 마지막 업데이트: 2026-07-20 (v4r 관찰 축 forward 편입) · 기준 커밋: 87fc038
...
## 2026-07-23 웹앱 섹터명 대소문자 무시 + 기존 중복 안전 통합 (승인 대기)
...
- 검증: 관련 테스트 90 passed, 전체 **407 passed, 기존 warning 1건**,
  ...
  보강한 뒤 최종 승인.
- 상태: `fix/case-insensitive-sectors` 브랜치, 커밋·push 전 오너 승인 대기.
  승인 후 main FF/push → 미니PC pull → 장 마감 후 uvicorn만 WMI 재기동 →
