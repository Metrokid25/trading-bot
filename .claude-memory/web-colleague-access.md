...
- 2026-07-22 추가: 신형 ETF는 `0167A0`처럼 영문 혼합 코드가 있음. KIS 실측
  ETF 1,143개 중 279개가 `숫자4+영문1+숫자1`. StockMaster/일봉 검증을 지원하고
  캐시 v3로 올린 `fix/alphanumeric-etf-codes`는 아직 미커밋·미니PC 미배포.
